...
class BVFooter
{
    ...
    public function buildSDKFooter()
    {
        ...
        $content_type = mb_strtoupper($this->base->config['bv_product']);
    ...
    public function buildSDKDebugFooter()
    {
        ...
        $local_seo_file_root = (!empty($this->base->config['internal_file_path'])) ? $this->base->config['internal_file_path'] : 'FALSE';
        //$content_type = mb_strtoupper($this->base->config['content_type']);
        $content_type = mb_strtoupper($this->base->config['bv_product']);
        $subject_type = mb_strtoupper($this->base->config['subject_type']);
        ...
        $footer .= "\n" . '   <li data-bvseo="bv.root.folder">' . $this->base->config['deployment_zone_id'] . '</li>';
        ...
        $footer .= "\n" . '   <li data-bvseo="crawlerAgentPattern">' . $this->base->config['bot_list'] . '</li>';
        //$footer .= "\n" . '   <li data-bvseo="subjectID">' . urlencode($this->base->config['subject_id']) . '</li>';
        $footer .= "\n" . '   <li data-bvseo="subjectID">' . urlencode($this->base->config['product_id']) . '</li>';
        ...
        $footer .= "\n" . '   <li data-bvseo="pageURI">' . $this->base->config['current_page_url'] . '</li>';
        //$footer .= "\n" . '   <li data-bvseo="baseURI">' . $this->base->config['base_url'] . '</li>';
        $footer .= "\n" . '   <li data-bvseo="baseURI">' . $this->base->config['base_page_url'] . '</li>';
